...
def getWeather():
    try:
        ...
        # Add API Key Weather
        api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=99e34de6913f56db0990a7da6f901bc7"
...
# Add Weather Logo
image_logo = PhotoImage(file="weather_logo_1.png")
...
# Label
label1 = Label(
    root, text="WIND", font=("Merriweather", 15, "bold"), fg="White", bg="#5AC9D9"
)
label1.place(x=100, y=330)

label2 = Label(
    root, text="HUMIDITY", font=("Merriweather", 15, "bold"), fg="White", bg="#5AC9D9"
)
...
label4 = Label(
    root, text="PRESSURE", font=("Merriweather", 15, "bold"), fg="White", bg="#5AC9D9"
)
